...
Version  : 5.12.4
Release  : 18
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtcanvas3d-everywhere-src-5.12.4.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtcanvas3d-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qtcanvas3d-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561149218
rm -rf %{buildroot}
