...
Version  : 5.12.2
Release  : 15
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.2/submodules/qtcanvas3d-everywhere-src-5.12.2.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.2/submodules/qtcanvas3d-everywhere-src-5.12.2.tar.xz
...
%prep
%setup -q -n qtcanvas3d-everywhere-src-5.12.2
...
%install
export SOURCE_DATE_EPOCH=1552683270
rm -rf %{buildroot}
