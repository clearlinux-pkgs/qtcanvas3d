...
Version  : 5.11.2
Release  : 10
URL      : http://download.qt.io/official_releases/qt/5.11/5.11.2/submodules/qtcanvas3d-everywhere-src-5.11.2.tar.xz
Source0  : http://download.qt.io/official_releases/qt/5.11/5.11.2/submodules/qtcanvas3d-everywhere-src-5.11.2.tar.xz
...
%prep
%setup -q -n qtcanvas3d-everywhere-src-5.11.2
...
%install
export SOURCE_DATE_EPOCH=1537304429
rm -rf %{buildroot}
