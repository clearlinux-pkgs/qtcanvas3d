...
Version  : 5.12.0
Release  : 11
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.0/submodules/qtcanvas3d-everywhere-src-5.12.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.0/submodules/qtcanvas3d-everywhere-src-5.12.0.tar.xz
...
%prep
%setup -q -n qtcanvas3d-everywhere-src-5.12.0
...
%install
export SOURCE_DATE_EPOCH=1544048707
rm -rf %{buildroot}
